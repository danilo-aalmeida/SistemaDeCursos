...
public class CadastrarPessoa {
	...
	public void cadastrarPessoa() {
		...
		if (opcao == 1) {
			...
			String tipoCadastro = "Funcionário";
			String dataAdimissao = JOptionPane.showInputDialog("Insira a data de adimissão: ");
			Double salario = Double.parseDouble(JOptionPane.showInputDialog("Insira o salário do funcionário: "));
			...
			String dataAdimissao = JOptionPane.showInputDialog("Insira a data de adimissão: ");
			Double salario = Double.parseDouble(JOptionPane.showInputDialog("Insira o salário do professor: "));
			String formacao = JOptionPane.showInputDialog("Insira a formação do professor: ");
			...
			JOptionPane.showMessageDialog(null, "Insira um tipo de pessoa válida!");
		}
	...
	public void excluirPessoa() {
		...
		Integer opcao = Integer.parseInt(JOptionPane.showInputDialog("Qual é o tipo de pessoa que deseja excluir? \n"
				+ "1 - Para Aluno \n"
				+ "2 - Para Funcionário \n"
				+ "3 - Para Professor"));
		if (opcao == 1 ) {
			...
			Integer matriculaEscolhida = Integer.parseInt("Qual é a matricula do aluno que deseja excluir? \n"
					+ dadosPessoas);
			alunos.remove(matriculaEscolhida);
		} else if (opcao == 2) {
			String dadosPessoas = "Tipo: ";
			for (Funcionario funcionario : funcionarios.values()) {
				dadosPessoas += "Funcionários: \n" + funcionario + "\n";
			}
			Integer matriculaEscolhida = Integer.parseInt("Qual é a matricula do funcionário que deseja excluir? \n"
					+ dadosPessoas);
			...
			Integer matriculaEscolhida = Integer.parseInt("Qual é a matricula do professor que deseja excluir? \n"
					+ dadosPessoas);
