...
public class CadastroRapido {
	...
	public void cadastrarRapidoCurso (HashMap<Integer, Curso> cursos, Integer contador) {
		...
		contadorCurso ++;
		Curso cursoRapido3 = new Curso(contadorCurso,"Depilação", 300.00);
	...
	public void cadastrarRapidoPessoa(HashMap<Integer, Aluno> alunos, HashMap <Integer, Funcionario> funcionarios, 
		...
		contadorPessoas++;
		Professor professorRapido3 = new Professor ("LARI ALECIO TIRELLI",5990,"15/11/1995","99057901",contadorPessoas,"Professor","24/10/2016",1500.0,"Depilação");
